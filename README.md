...
-------------
1) Пакет переименован с ***simple-popup*** на ***easy-popup***, т.к. на момент публикации имя ***simple-popup*** уже занято в ***npm***. Соответственно, изменено имя объекта попапа c ***SimplePopup*** на ***EasyPopup***, а также изменены приставки в css-классах с ***simple-popup*** на ***easy-popup***.
