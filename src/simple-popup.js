...
window.SimplePopup = function() {
    ...
    localFunctions.ready(function(){
        ...
        if (popupTint)
            ...
            popupParent.innerHTML += '<div class="simple-popup-tint" data-id="'+Popup.id+'"></div>';
        ...
        for (var name in templates) {
            ...
            if (templates[name] === false) {
                ...
                var popupItem = document.querySelectorAll('.simple-popup-tint[data-id="'+Popup.id+'"] .simple-popup[data-name="'+name+'"]');
                if (popupItem.length) {
                    //popupItem.remove();
            ...
            if (!document.querySelectorAll('.simple-popup-tint[data-id="'+Popup.id+'"] .simple-popup[data-name="'+name+'"]').length)
                html += templates[name];
        }

        if (!document.querySelector('.simple-popup-tint[data-id="'+Popup.id+'"] .simple-popup__loading'))
            html += '<div class="simple-popup__loading"></div>';

        //$('.simple-popup-tint').append(html);
        document.querySelector('.simple-popup-tint[data-id="'+Popup.id+'"]').innerHTML += html;
    ...
    this.close = function() {
        ...
        */
        ...
        setTimeout(function(){
            //$('html, body').stop(true);
            var tint = document.querySelector('.simple-popup-tint[data-id="'+Popup.id+'"]');
    ...
    this.setLoading = function() {
        ...
        localFunctions.addClass(document.querySelector('.simple-popup-tint[data-id="'+this.id+'"]'), 'is_loading');
    ...
    this.unsetLoading = function() {
        ...
        localFunctions.removeClass(document.querySelector('.simple-popup-tint[data-id="'+this.id+'"]'), 'is_loading');
