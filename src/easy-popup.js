...
window.EasyPopup = function() {
    ...
    this.setLoading = function() {
        ...
        localFunctions.addClass(document.querySelector('.easy-popup-tint[data-id="'+this.id+'"]'), 'is_loading');
    ...
    this.unsetLoading = function() {
        ...
        localFunctions.removeClass(document.querySelector('.easy-popup-tint[data-id="'+this.id+'"]'), 'is_loading');
